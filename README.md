...
Klasa `pl.zzpj2019.cleancode.doIt` nie przestrzega zasad Clean Code. Przerefaktoruj kod zgodnie z zasadami poznanymi podczas wykładu.
...
Pakiet, w którym należy umieścić rozwiązanie: `pl.zzpj2019.solid.srp.book.solution`
...
Pakiet, w którym należy umieścić rozwiązanie: `pl.zzpj2019.solid.ocp.usa.solution`
...
Pakiet w którym należy dostarczyć rozwiązanie: `pl.zzpj2019.solid.lsp.shape`
...
Pakiet, w którym należy dostarczyć rozwiązanie: `pl.zzpj2019.solid.isp.contactbook.solution`
...
Pakiet, w którym należy dostarczyć rozwiązanie: `pl.zzpj2019.solid.dip.weathertracker.solution`